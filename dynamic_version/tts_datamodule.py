...
from collation import get_text_token_collater, get_audio_token_collater, get_mel_collater
from asr_dataset import SpeechSynthesisDataset
...
class TtsDataModule:
    ...
    def add_arguments(cls, parser: argparse.ArgumentParser):
        ...
        group.add_argument(
            "--manifest-dir",
            type=Path,
            default=Path("/Dataset/mas-chen.weidong/project_c/valle/vall-e/egs/libritts/data/tokenized"),
